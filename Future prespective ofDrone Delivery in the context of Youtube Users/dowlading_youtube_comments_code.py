...
var
result = [['Channel URL', 'Name', 'Comment', 'Time', 'Likes', 'Reply Count', 'Reply Author', 'Reply', 'Published',
           'Updated']];
var
vid = ss.getSheetByName('Input').getRange(1, 2).getValue();
var
...
var
newSheet = ss.insertSheet(ss.getNumSheets());
